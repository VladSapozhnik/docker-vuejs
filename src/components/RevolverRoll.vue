  ...
  <div class="roll">
    <div class="container">
      ...
      <div class="roll__wrapper">
        ...
        <div class="roll__wrapper-btn"><span @click="triggerRoll" v-if="this.thing != 2">Нажать на курок</span><span @click="resetRoll" v-if="this.thing == 2">Начать заново?</span></div>
      </div>
  ...
  methods: {
      ...
      triggerRoll: function () {
          if (this.stackRoll.length > 0) {
              ...
              this.triggerRollText = 'Нажать на курок'
              if (this.thing == 2) {
